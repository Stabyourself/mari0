...
function platform:init(x, y, r)
	...
	--SIZE
	if #self.r > 0 then
		self.size = platformwidthfunction(tonumber(self.r[1]))
		table.remove(self.r, 1)
	end
	
	--Distance
	if #self.r > 0 then
		self.distance = platformdistancefunction(tonumber(self.r[1]))
		table.remove(self.r, 1)
	end
	
	--Time
	if #self.r > 0 then
		self.time = platformtimefunction(tonumber(self.r[1]))
		table.remove(self.r, 1)
	end
	
	--SPEED
	if #self.r > 0 then
		self.speed = platformspeedfunction(tonumber(self.r[1]))
		table.remove(self.r, 1)
	end
