...
function onlinemenu_draw()
	...
	properprint("online play", 4*scale, 5*scale, true)
	
	properprint("your nick:", 4*scale, 20*scale, true)
	guielements.nickentry:draw()
	
	properprint("use config", 140*scale, 20*scale, true)
	properprint("number  " .. playerconfig , 140*scale, 33*scale, true)
	...
	love.graphics.setColor(255, 255, 255)
	properprint("join game", 64*scale, 60*scale, true)
	
	properprint("address/magicdns", 36*scale, 77*scale, true)
	guielements.ipentry:draw()
	love.graphics.setColor(150, 150, 150)
	properprint("enter ip, hostname,", 24*scale, 107*scale, true)
	properprint("domain or magicdns", 28*scale, 117*scale, true)
	properprint("words to connect.", 32*scale, 127*scale, true)
	
	love.graphics.setColor(255, 255, 255)
	properprint("optional port:", 21*scale, 148*scale, true)
	guielements.portentry2:draw()
	
	love.graphics.setColor(150, 150, 150)
	properprint("not needed when", 40*scale, 162*scale, true)
	properprint("connecting through", 28*scale, 172*scale, true)
	properprint("magicdns", 68*scale, 182*scale, true)
	...
	love.graphics.setColor(255, 255, 255)
	properprint("host game", 260*scale, 60*scale, true)
	properprint("port", 280*scale, 77*scale, true)
	
	guielements.portentry:draw()
	
	love.graphics.setColor(150, 150, 150)
	properprint("port will need to", 230*scale, 107*scale, true)
	properprint("be udp forwarded for", 218*scale, 117*scale, true)
	properprint("internet play!", 242*scale, 127*scale, true)
	
	guielements.magiccheckbox:draw()
	properprint("use magicdns words", 230*scale, 148*scale, true)
	love.graphics.setColor(150, 150, 150)
	properprint("allows friends", 238*scale, 162*scale, true)
	properprint("to join using", 242*scale, 172*scale, true)
	properprint("two short words", 234*scale, 182*scale, true)
